 ...
 * within the billing service. All callers pass the {@code planCode} extracted from the caller's
...
public class PlanFeatureGuard {
  ...
  public PlanFeatureGuard(final PlanFeatureRegistry planFeatureRegistry) {
