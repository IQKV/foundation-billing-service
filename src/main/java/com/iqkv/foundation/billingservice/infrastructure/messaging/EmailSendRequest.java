 ...
 * resolution are complete. Each {@link EmailSender} implementation receives one
 * of these and is responsible only for delivering it — no knowledge of Thymeleaf,
 * MessageSource, or {@link NotificationEvent} required.
 *
 * @param from     the sender address (e.g. {@code "noreply@iqkv.com"})
