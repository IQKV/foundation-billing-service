...
/**
 * Mirror of IAM's UserEvent consumed by the Billing service.
 * Only event types relevant to billing are handled; others are logged and discarded.
 */
public class UserEvent {
  ...
  public enum EventType {
    ...
    USER_UPDATED,
    USER_DELETED,
    USER_REMOVED   // membership removal from a specific tenant
  }
