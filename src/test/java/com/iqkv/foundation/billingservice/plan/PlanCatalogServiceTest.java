...
class PlanCatalogServiceTest {
  ...
  void shouldCreatePlan() {
    final var request = new PlanRequest("new-plan", "New", "MONTHLY", 100, "USD", null, "TENANT", true);
  ...
  void shouldThrowOnDuplicateCreate() {
    final var request = new PlanRequest("dup", "D", "MONTHLY", 1, "USD", null, "TENANT", true);
  ...
  void shouldPatchPlan() {
    ...
    final var patch = new PlanPatchRequest(null, null, 5000, null, null, null, false);
